...
@Service(value = PipelineNodeBizCodeConst.MERGE_BRANCH)
public class PipelineNodeMergeBranchJob implements PipelineNodeJobExecutor {
    ...
    public PipelineNodeJobExecuteResult handleBackend(PipelineTemplateTb pipelineTemplate, PipelineInstanceTb pipelineInstance, Map<String, Object> contextArgs) {
        ...
        pipelineInstanceNodeDetailService.addLog(pipelineInstanceId, contextArgs, "集成区分支 xxxxxx 合并到release分支成功", PipelineStatusEnum.SUCCESS, "");
