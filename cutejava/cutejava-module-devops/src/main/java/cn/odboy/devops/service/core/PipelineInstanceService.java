...
public interface PipelineInstanceService {
    ...
    StartPipelineResultVo retryPipelineNode(PipelineInstanceVo args);

    StartPipelineResultVo restartPipeline(RestartPipelineArgs args);

    void stopPipeline(RestartPipelineArgs args);
}
