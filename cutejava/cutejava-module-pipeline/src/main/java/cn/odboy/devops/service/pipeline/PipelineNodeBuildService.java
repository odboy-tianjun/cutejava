 ...
 * @date 2025-07-24
 */
@Service(value = PipelineConst.EXECUTOR_PREFIX + "node_build")
public class PipelineNodeBuildService extends AbstractPipelineNodeJobService implements PipelineNodeJobExecutor {
    @Autowired
