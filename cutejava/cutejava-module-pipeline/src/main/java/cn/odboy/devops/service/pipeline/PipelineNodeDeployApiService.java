 ...
 * @date 2025-07-24
 */
@Service(value = PipelineConst.EXECUTOR_PREFIX + "node_deploy_api")
public class PipelineNodeDeployApiService extends AbstractPipelineNodeJobService implements PipelineNodeJobExecutor {
    @Autowired
