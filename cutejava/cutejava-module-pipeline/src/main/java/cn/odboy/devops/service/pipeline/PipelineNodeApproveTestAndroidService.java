...
/**
 * 流水线节点任务：人工确认Android测试通过
 *
 * @author odboy
 * @date 2025-07-24
 */
@Service(value = PipelineConst.EXECUTOR_PREFIX + "node_approve_test_android")
public class PipelineNodeApproveTestAndroidService extends AbstractPipelineNodeJobService implements PipelineNodeJobExecutor {
    @Autowired
    private PipelineNodeDemoBiz pipelineNodeDemoBiz;
