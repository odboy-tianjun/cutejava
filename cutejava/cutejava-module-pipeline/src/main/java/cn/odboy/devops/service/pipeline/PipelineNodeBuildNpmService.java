 ...
 * @date 2025-07-24
 */
@Service(value = PipelineConst.EXECUTOR_PREFIX + "node_build_npm")
public class PipelineNodeBuildNpmService extends AbstractPipelineNodeJobService implements PipelineNodeJobExecutor {
    @Autowired
