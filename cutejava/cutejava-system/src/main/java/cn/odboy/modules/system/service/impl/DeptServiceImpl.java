...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements DeptService {
    ...
    public List<Dept> queryAll(DeptQueryCriteria criteria, Boolean isQuery) throws Exception {
        ...
        List<Dept> list = deptMapper.findDept(criteria);
    ...
    public List<Dept> findByPid(long pid) {
        return deptMapper.findDeptByPid(pid);
    }
    ...
    public Set<Dept> getDeleteDepts(List<Dept> menuList, Set<Dept> deptSet) {
        for (Dept dept : menuList) {
            deptSet.add(dept);
            List<Dept> depts = deptMapper.findDeptByPid(dept.getId());
    ...
    public List<Dept> getSuperior(Dept dept, List<Dept> depts) {
        if (dept.getPid() == null) {
            depts.addAll(deptMapper.findDeptByPidIsNull());
            return depts;
        }
        depts.addAll(deptMapper.findDeptByPid(dept.getPid()));
