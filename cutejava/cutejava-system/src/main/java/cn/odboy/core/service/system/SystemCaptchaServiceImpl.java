...
public class SystemCaptchaServiceImpl implements SystemCaptchaService {
    ...
    public SendSystemEmailArgs renderCodeTemplate(String email, String key) {
        SendSystemEmailArgs sendEmailRequest;
        String content;
        ...
        sendEmailRequest = new SendSystemEmailArgs(Collections.singletonList(email), "CuteJava后台管理系统", content);
