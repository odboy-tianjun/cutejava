package cn.odboy.core.framework.mybatisplus.core;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.odboy.base.CsBaseUserTimeTb;
import cn.odboy.core.framework.mybatisplus.config.CsMpQuery;
...
public class CsMpSimpleQUtil {
        ...
        try {
            ...
            for (Field field : fields) {
                if (!field.canAccess(query)) {
                    ...
                    CsMpQuery q = field.getAnnotation(CsMpQuery.class);
                    if (q != null) {
    ...
    private static String getAttributeName(CsMpQuery q, Field field) {
