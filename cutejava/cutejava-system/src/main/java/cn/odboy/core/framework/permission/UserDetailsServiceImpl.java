...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    private final SystemUserCacheApi systemUserCacheApi;

    @Override
    public UserJwtVo loadUserByUsername(String username) {
        UserJwtVo userJwtVo = systemUserCacheApi.describeUserJwtModelByUsername(username);
        if (userJwtVo == null) {
            ...
            if (user == null) {
                ...
                // 添加缓存数据
                systemUserCacheService.saveUserJwtModelByUserName(username, userJwtVo);
            }
        }
        return userJwtVo;
    }
