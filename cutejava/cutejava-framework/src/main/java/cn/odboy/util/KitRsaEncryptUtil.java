...
public final class KitRsaEncryptUtil {
    ...
    private static void test1(RsaKeyPair keyPair) throws Exception {
        ...
        String text1 = encryptByPublicKey(keyPair.getPublicKey(), KitRsaEncryptUtil.SRC);
        String text2 = decryptByPrivateKey(keyPair.getPrivateKey(), text1);
        System.out.println("加密前：" + KitRsaEncryptUtil.SRC);
        System.out.println("加密后：" + text1);
        System.out.println("解密后：" + text2);
        if (KitRsaEncryptUtil.SRC.equals(text2)) {
    ...
    private static void test2(RsaKeyPair keyPair) throws Exception {
        ...
        String text1 = encryptByPrivateKey(keyPair.getPrivateKey(), KitRsaEncryptUtil.SRC);
