 ...
 */
@UtilityClass
public final class CsRsaEncryptUtil {
    ...
    private static void test1(RsaKeyPair keyPair) throws Exception {
        ...
        String text1 = encryptByPublicKey(keyPair.getPublicKey(), CsRsaEncryptUtil.SRC);
        String text2 = decryptByPrivateKey(keyPair.getPrivateKey(), text1);
        System.out.println("加密前：" + CsRsaEncryptUtil.SRC);
        System.out.println("加密后：" + text1);
        System.out.println("解密后：" + text2);
        if (CsRsaEncryptUtil.SRC.equals(text2)) {
    ...
    private static void test2(RsaKeyPair keyPair) throws Exception {
        ...
        String text1 = encryptByPrivateKey(keyPair.getPrivateKey(), CsRsaEncryptUtil.SRC);
