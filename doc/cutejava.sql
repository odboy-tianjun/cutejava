...
CREATE TABLE `system_local_storage` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='本地存储';

-- ----------------------------
-- Records of system_local_storage
-- ----------------------------
BEGIN;
INSERT INTO `system_local_storage` (`id`, `real_name`, `name`, `suffix`, `path`, `type`, `size`, `date_group`, `create_by`, `update_by`, `create_time`, `update_time`) VALUES (22, '15796374-20250625063744622.jpeg', '15796374', 'jpeg', '/Users/odboy/cutejava/file/20250625/15796374-20250625063744622.jpeg', 'image', '37.76 KB', '20250625', 'admin', 'admin', '2025-06-25 18:37:45', '2025-06-25 18:37:45');
COMMIT;
